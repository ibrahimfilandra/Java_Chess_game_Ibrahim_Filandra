...
public class Pawn extends ChessPiece{
    ...
    void move(String position) {
        ...
        if(this.color==Color.WHITE && this.position.charAt(1)=='2'){
            if(position.charAt(1)==4 && this.position.charAt(0)==position.charAt(0)) this.position=position;
        }
       else if(this.color==Color.BLACK && this.position.charAt(1)=='7'){
